# Clustering assignment -3 ads-1
"""
Created on Sun Jan 21 04:12:54 2024
...
def perform_clustering_new(data):
    ...
    data["Cluster"] = labels
    data.to_excel("C:\\Users\\User\\Downloads\\cluster_result-n2.xlsx", index = False)#change the excel sheet name executing every time while executing 
